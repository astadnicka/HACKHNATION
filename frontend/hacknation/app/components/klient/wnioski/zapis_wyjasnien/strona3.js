  ...
  return (
    <div className="bg-gray-50/60 w-full max-w-2xl p-4 rounded-xl flex flex-col space-y-4 mb-4">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-2">
            <button className={buttonClassName}>przebywałem/am</button>
            <span className={separatorClassName}>/</span>
            <button className={buttonClassName}>nie przebywałem/am</button>
      ...
      <div className='flex justify-between gap-4'>
        <div className='space-y-1'>
          <input className={simpleClassName} placeholder='miejscowość'></input>
          <input className={simpleClassName} type='date'></input>
        </div>
        <div>
          <textarea className={`${simpleClassName} resize-none h-20`} placeholder='podpis poszkodowanego'></textarea>
        </div>
      </div>
      <div className='flex gap-4 items-start'>
        <label className='text-sm pt-2'>Protokowali i potwierdzili własnoręczność podpisu</label>
        <textarea className={`${simpleClassName} resize-none h-20`} placeholder='........'></textarea>
      </div>
      <div className='mt-8'>
